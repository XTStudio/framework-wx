...
export class Matrix {
    ...
    static unmatrix(matrix: Matrix): { scale: { x: number, y: number }, degree: number, translate: { x: number, y: number } } {
        var A = matrix.a
        var B = matrix.b
        var C = matrix.c
        var D = matrix.d
